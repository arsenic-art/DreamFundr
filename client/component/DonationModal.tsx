            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl max-w-md w-full p-6 relative animate-in zoom-in-95 duration-200">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-zinc-400 text-sm">
                        Support <span className="text-white font-medium">{fundraiserTitle}</span>
                    </p>
                </div>

                {/* Quick Amount Buttons */}
                <div className="mb-4">
                    <label className="text-sm text-zinc-400 mb-2 block">Quick Select</label>
                    <div className="grid grid-cols-4 gap-2">
                        {quickAmounts.map((amt) => (
                            <button
                                ...
                                disabled={loading}
                                className={`py-2 px-3 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed ${donationAmount === amt.toString()
                ...
                {/* Custom Amount Input */}
                <div className="mb-6">
                    <label className="text-sm text-zinc-400 mb-2 block">Or Enter Amount</label>
